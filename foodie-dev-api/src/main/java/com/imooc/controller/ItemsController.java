...
public class ItemsController extends BaseController {
    ...
    /**
     * 用于用户长时间未登录网站, 刷新购物车中的数据(主要是商品的价格), 类似京东淘宝
     *
     * @return
     */
    ...
    public IMOOCJSONResult refresh(
            ...
            @RequestParam(value = "itemSpecIds", required = false) String itemSpecIds) {
        if (StringUtils.isBlank(itemSpecIds)) {
            return IMOOCJSONResult.ok();
        }
        List<ShopcartVO> list = itemService.searchItemsBySpecIds(itemSpecIds);
