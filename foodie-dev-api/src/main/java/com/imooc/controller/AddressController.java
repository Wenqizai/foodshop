...
public class AddressController {
    ...
    @PostMapping("/add")
    public IMOOCJSONResult add(@ApiParam(name = "AddressBO", value = "地址BO", required = true) @RequestBody AddressBO addressBO) {
    ...
    @PostMapping("/update")
    public IMOOCJSONResult update(@ApiParam(name = "AddressBO", value = "地址BO", required = true) @RequestBody AddressBO addressBO) {
